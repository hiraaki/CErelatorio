...
public class Main {
    ...
    public static void  onePlusOne(Populacao p,int geracao){
        ...
        for(int i=0;i<geracao;i++){
            ...
            for(int j=0;j<p.individuos.size();j++){
                Individuos a = geracoes.get(geracoes.size()-1).individuos.get(numeroAleatorio(0,19));
